...
public class BestLegalMoveStrategy extends AbstractStrategy {

	public BestLegalMoveStrategy(IGameMoveEvaluator evaluator) {
		super(new BestLegalMoveSelector(evaluator));
	}
