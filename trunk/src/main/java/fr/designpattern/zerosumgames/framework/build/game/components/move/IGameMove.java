...
import fr.designpattern.zerosumgames.framework.build.game.components.IGameNullableComponent;
 ...
 */
public interface IGameMove extends IGameNullableComponent, Comparable<IGameMove> {
