...
public abstract class AbstractGamePlayService implements
    ...
    // ---------------------------------------------------------------------
    protected final List<LegalMoveInterface> getLegalMoves(
            final OpponentsEnumeration sideToPlay) {
        return this.getGamePlay().getLegalMoves(sideToPlay);
    }

    // ---------------------------------------------------------------------
    protected final OpponentInterface getOpponentByOrder(
            final OpponentsEnumeration sideToPlay) {
