...
package fr.designpattern.zerosumgames.game.components.opponents.strategies.selectors;
...
import fr.designpattern.zerosumgames.game.components.move.IGameMoveEvaluator;
import fr.designpattern.zerosumgames.game.components.move.IGameMoveSelector;
import fr.designpattern.zerosumgames.game.components.opponents.GamePlayersEnumeration;
import fr.designpattern.zerosumgames.game.components.opponents.strategies.selectors.heuristics.OneSingleMoveExists;
import fr.designpattern.zerosumgames.game.components.opponents.strategies.selectors.heuristics.WinningMoveExists;
...
public class BestMoveSelector implements IGameMoveSelector {
	...
	//--------------------------------------------------------------------------------------
	public IGameMove select(final IGame context,  final List<IGameMove> legalMoves) {
