...
package fr.designpattern.zerosumgames.framework.gameplay.game.board.dimension;
...
public class Dimension implements DimensionInterface {
	...
	// ---------------------------------------------------------------------
	public Dimension(final int minRowIndex, final int maxRowIndex, final int minColumnIndex, final int maxColumnIndex) throws RuntimeException {
