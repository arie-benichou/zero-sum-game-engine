...
public class _MiniMaxEvaluatorThread implements Callable<Double> {
    ...
    //--------------------------------------------------------------------------------------
    public MiniMaxEvaluatorThread(final GameInterface localContext, final LegalMoveInterface moveToEvaluate, final int profondeur, final double side) {
        this.moveToEvaluate = moveToEvaluate;
        this.localContext = localContext;
        this.maximalDepth = this.maximalDepth;
    }
