...
abstract class AbstractPosition implements Positions.Interface {
    ...
    public final boolean equals(final Object object) {
        ...
        else if (!(object instanceof Positions.Interface)) {
            isEqual = false;
        }
        else {
            final Positions.Interface position = (Positions.Interface) object;
    ...
    public final int compareTo(final Positions.Interface position) {
