...
package context.entity.adversity.player.strategy;

import java.util.List;

import util.interfaces.ImmutableInterface;
import context.ContextInterface;
import context.entity.adversity.player.strategy.evaluation.EvaluationInterface;
import context.entity.adversity.player.strategy.selection.SelectionInterface;
