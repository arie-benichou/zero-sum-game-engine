...
class BoardBuilder {
    ...
    public static void main(final String[] args) {
        ...
        board1.getCell(1, 1).setPiece(Piece(Side.SECOND_PLAYER));
        board1.getCell(2, 2).setPiece(Piece(Side.SECOND_PLAYER));
        ...
        board2.getCell(1, 1).setPiece(Piece(Side.FIRST_PLAYER));
        board2.getCell(2, 2).setPiece(Piece(Side.FIRST_PLAYER));
        System.out.println(board2);
